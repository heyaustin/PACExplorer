...
export class MainMenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    let playButton = this.add
      .image(700, 50, CST.IMAGE.PLAY)
      .setDepth(1)
      .setScale(0.55)
    let optionsButton = this.add
      .image(700, 150, CST.IMAGE.OPTIONS)
      .setDepth(1)
      .setScale(0.55)
    let quitButton = this.add
      .image(700, 250, CST.IMAGE.QUIT)
      .setDepth(1)
      .setScale(0.55)
    let hoverImg = this.add
      .image(100, 100, CST.IMAGE.HOVER)
      .setScale(0.2)
      .setVisible(false)

    //let board = this.add.image(180, 562, CST.IMAGE.BOARD).setDepth(1).setScale(0.8);
    let FETRPG = this.add
      .image(80, 85, CST.IMAGE.FETRPG_LOGO)
      .setDepth(1)
      .setScale(0.3)
    let NTUAI_Button = this.add
      .image(100, 550, CST.IMAGE.NTUAI_LOGO)
      .setDepth(1)
      .setScale(0.25)
    //let FET_Button = this.add.image(300, 550, CST.IMAGE.FET_LOGO).setDepth(1).setScale(0.1);
    let ATCC_Button = this.add
      .image(500, 550, CST.IMAGE.ATCC_LOGO)
      .setDepth(1)
      .setScale(0.25)
    let FET_Button = this.add
    ...
    quitButton.on("pointerup", () => {
      window.location.href = "https://pacexplorer.co"
    })
