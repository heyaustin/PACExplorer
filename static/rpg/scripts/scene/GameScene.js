...
export class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.ceo_room = this.add
      .image(0, 0, CST.IMAGE.CEO_ROOM)
      .setOrigin(0)
      .setDepth(0)
    this.hr_room = this.add
      .image(0, 0, CST.IMAGE.HR_ROOM)
      .setOrigin(0)
      .setDepth(0)
    this.engineer_room = this.add
      .image(0, 0, CST.IMAGE.ENGINEER_ROOM)
      .setOrigin(0)
      .setDepth(0)
    this.marketing_room = this.add
      .image(0, 0, CST.IMAGE.MARKETING_ROOM)
      .setOrigin(0)
      .setDepth(0)
    ...
    // background music
    this.music = this.sound.add(CST.AUDIO.GAME_MUSIC, {
      loop: true,
      volume: 0.3
    })
    this.music.play()
    ...
    this.add
      ...
      .strokeRect(600, 2, 198, 596)
    this.add
      .graphics()
      .lineStyle(5, 0x5c4033, 1)
      .strokeRect(2, 2, 596, 596)
    this.add
      .graphics()
      .lineStyle(5, 0x5c4033, 1)
