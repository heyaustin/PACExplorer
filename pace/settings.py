"""
Django settings for PACExplorer project.
...
if "DEV" not in os.environ:
    ALLOWED_HOSTS = ["*"] + ["pacexplorer.co", "127.0.0.1"]
    CSRF_TRUSTED_ORIGINS = ['https://pacexplorer.co', 'http://pacexplorer.co']
else:
    ...
    if "TEST_NGROK_URL" in os.environ:
        ...
        CSRF_TRUSTED_ORIGINS = [TEST_NGROK_URL,
                                'https://pacexplorer.co', 'http://pacexplorer.co']
    else:
        ALLOWED_HOSTS = ["*"] + ["pacexplorer.co",
